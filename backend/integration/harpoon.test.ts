  ...
  suite("Persistence", () => {
    test("Marks should persist between sessions", async function () {
      ...
      try {
        ...
        // Simulate reload by creating new manager instance
        // Note: This is a simplified test - real persistence is tested across extension restarts
        const marks = manager.getMarks();
